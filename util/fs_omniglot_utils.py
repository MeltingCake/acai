...
def string_to_strokes(stroke_str, epsilon=2.):
    """
    Convert strings to omniglot strokes
    :param stroke_str:
    :param epsilon:
    :return:
    """
...
def apply_rdp(strokes, epsilon=1.5):
    """
    Apply Ramer-Douglas-Peucker algorithm to a list of strokes.
    :param strokes:
    :param epsilon:
    :return:
    """
